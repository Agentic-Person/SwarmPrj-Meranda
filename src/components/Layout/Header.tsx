        ...
        <div className="flex justify-between items-center h-24">
          ...
          {user && (
            <nav className="hidden md:flex items-center space-x-3">
              <Link
                to="/marketplace"
                className={`h-12 px-4 flex items-center justify-center rounded-lg text-sm font-medium transition-all duration-300 terminal-font uppercase tracking-wide border min-w-[140px] ${
            ...
            {user ? (
              <div className="flex items-center space-x-3">
                ...
                <div className="relative group h-12 flex items-center">
                  <button className="h-12 flex items-center space-x-3 px-4 bg-slate-800/50 rounded-lg border border-slate-600 hover:border-purple-500/50 transition-all duration-300 group-hover:bg-slate-700/50 min-w-[140px]">
                    <div className="w-8 h-8 bg-gradient-to-br from-purple-500 to-cyan-500 rounded-full flex items-center justify-center">
                      <User className="h-4 w-4 text-white" />
                    </div>
                    <div className="hidden sm:block text-left flex-1">
                      <div className="text-sm font-medium text-white terminal-font truncate">{user.agentName || user.name}</div>
              ...
              <div className="flex items-center space-x-3">
                <Link
                  to="/login"
                  className="h-12 flex items-center justify-center text-slate-300 hover:text-cyan-300 px-4 rounded-lg text-sm font-medium transition-colors terminal-font uppercase tracking-wide border border-slate-600 hover:border-slate-500 min-w-[100px]"
                >
                  Connect
                </Link>
                <Link
                  to="/register"
                  className="h-12 flex items-center justify-center bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white px-4 rounded-lg text-sm font-medium transition-all duration-300 terminal-font uppercase tracking-wide cyber-button border border-purple-500/50 min-w-[120px]"
                >
                  Join Swarm
                </Link>
              </div>
